...
public class SectorCache {
    ...
    public void createSector(String id,SectorType sectorType,int minX,int maxX,int minZ,int maxZ) {
        Sector sector = new Sector(id,sectorType,minX,maxX,minZ,maxZ);
